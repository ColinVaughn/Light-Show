...
public enum ParticleRegistry {
    ...
    EXPLOSION_HUGE(2, Particle.EXPLOSION),
    FIREWORKS_SPARK(3, Particle.FIREWORK),
    WATER_BUBBLE(4, Particle.BUBBLE),
    WATER_SPLASH(5, Particle.BUBBLE_POP),
    WATER_WAKE(6, Particle.FISHING),
    SUSPENDED(7, Particle.VIBRATION),
    SUSPENDED_DEPTH(8, Particle.VIBRATION),
    CRIT(9, Particle.CRIT),
    CRIT_MAGIC(10, Particle.CRIT),
    SMOKE_NORMAL(11, Particle.SMOKE),
    SMOKE_LARGE(12, Particle.SMOKE),
    SPELL(13, Particle.WITCH),
    SPELL_INSTANT(14, Particle.WAX_ON),
    SPELL_MOB(15, Particle.GUST_EMITTER_LARGE),
    SPELL_MOB_AMBIENT(16, Particle.GUST_EMITTER_SMALL),
    ...
    SNOW_SHOVEL(29, Particle.ASH),
    SLIME(30, Particle.ITEM_SLIME),
    HEART(31, Particle.HEART),
    WATER_DROP(33, Particle.FALLING_WATER),
    MOB_APPEARANCE(34, Particle.SOUL_FIRE_FLAME),
